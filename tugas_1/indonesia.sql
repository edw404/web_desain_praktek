...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2016 at 04:32 AM
...
INSERT INTO `ongkos` (`id_ongkos`, `id_kabupaten`, `harga`) VALUES
(1, 2, 50000);
...
INSERT INTO `tbl_kabupaten` (`id_kabupaten`, `nama_kabupaten`, `id_provinsi`) VALUES
(2, 'ACEH SELATAN', 1),
(269, 'ACEH TENGGARA', 1),
(671, 'ACEH TIMUR', 1),
(1207, 'ACEH TENGAH', 1),
